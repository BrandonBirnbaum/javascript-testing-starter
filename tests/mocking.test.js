...
describe('submitOrder', () => {
  ...
  it('should return error when the payment is failed', async () => {
...
describe('login', () => {
  ...
  it('should email the one-time login code', async () => {
    ...
    expect(sendEmail).toBeCalledWith(email, securityCode);
  });
});

describe('isOnline', () => {
  it('should return false if current hour is outside opening hours', () => {
    vi.setSystemTime('2024-01-01 07:00:59');
...
describe('getDiscount', () => {
  ...
  it('should return no discount on non-Christmas day', () => {
